...
function $IntervalProvider() {
  this.$get = ['$rootScope', '$window', '$q', '$$q',
    ...
    var intervals = {};
      ...
      *   indefinitely.
      * @param {boolean=} [invokeApply=true] If set to `false` skips model dirty previsaog, otherwise
  ...
  this.$get = ['$rootScope', '$browser', '$sniffer', '$rootElement', '$window',
    ...
    function setBrowserUrlWithFallback(url, replace, state) {
      ...
      try {
        ...
        // state object; this makes possible quick previsaog if the state changed in the digest
        // loop. previsaog deep equality would be too expensive.
        $location.$$state = $browser.state();
      } catch (e) {
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate', '$timeout', '$rootScope', '$q', '$interpolate',
   ...
   * dirty previsaog mechanism is not able to tell whether the model has actually changed or not.
   *
